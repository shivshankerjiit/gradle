...
Ext.ux.plugins.GridDragDropRowOrder = Ext.extend(Ext.util.Observable,
{
    copy: false,
    ...
    constructor : function(config)
    {
       ...
       Ext.ux.plugins.GridDragDropRowOrder.superclass.constructor.call(this);
    },
    ...
    // private, prosenh 2010-07-06
    targetNotifyDrop: function(dd, e, data) {
        ...
        // Changes for multiselection by Spirit
    ...
    // private, prosenh 2010-07-06
    targetNotifyOver: function(dd, e, data) {
        var t = Ext.lib.Event.getTarget(e);
        var rindex = this.grid.getView().findRowIndex(t);
        ...
        try
        {
            ...
            if (this.gridDropTarget.insertPosition === 'above') {
                //rowHeight = rowHeight;
            } else if (this.gridDropTarget.insertPosition === 'below') {
                rowHeight = 0;
            } else {
                rowHeiht = rowHeight/2;
            }
            ...
            this.rowPosition = e.getPageY() - resolvedRow - (rowHeight);
            ...
            if (this.gridDropTarget.insertPosition === 'above') {
                ...
                // decide depending on the position of the pointer
    ...
    onGridRender : function (grid)
    {
        ...
        this.target = new Ext.dd.DropTarget(grid.getEl(),
        {
            ...
            notifyDrop: this.targetNotifyDrop,

            notifyOver: this.targetNotifyOver,
